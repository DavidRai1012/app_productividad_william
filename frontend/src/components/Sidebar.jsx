  ...
  return (
    <aside className="sidebar glass">
      ...
      <button 
        ...
        style={currentMode !== 'garden' ? { background: 'transparent', color: 'var(--text-color)', border: '1px solid transparent', textAlign: 'left', display: 'flex', alignItems: 'center', gap: '10px'} : { textAlign: 'left', display: 'flex', alignItems: 'center', gap: '10px' }}
